...
class GenePatternController {
	...
	def runheatmap = {
		...
		accessLogService.report "Heatmap Analysis: $analysis, Job: $jobName", "RID1: $rID1, RID2: $rID2"
	...
	def runsurvivalanalysis = {
		...
		def userName = springSecurityService.getPrincipal().username
		accessLogService.report "Survival Analysis, Job: $jobName", "RID1: $rID1, RID2: $rID2"
	...
	def runhaploviewer = {
		...
		def userName = springSecurityService.getPrincipal().username
		accessLogService.report "Haploview Job: $jobName", "RID1: $rID1, RID2: $rID2, Genes: $genes"
	...
	def runhaploviewersample = {
		...
		def userName = springSecurityService.getPrincipal().username
		accessLogService.report "Haploview Job: $jobName", "Sample IDs JSON: $sampleIdListJSON, Genes: $genes"
	...
	def runGwas = {
		...
		def userName = springSecurityService.getPrincipal().username
		accessLogService.report "Survival Analysis, Job: $jobName", eventmessage: "RID1: $rID1, RID2: $rID2"
