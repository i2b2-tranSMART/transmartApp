...
class GeneSignatureController {
	...
	def createListWizard() {
		AuthUser user = AuthUser.get(securityService.currentUserId())
		GeneSignature geneSig = new GeneSignature(createdByAuthUser: user, publicFlag: false,
	...
	def editWizard(GeneSignature geneSig) {
		...
		setSessionWizard new WizardModelDetails(loggedInUser: securityService.principal(),
