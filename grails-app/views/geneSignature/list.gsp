...
<body>
<div class="body">
	<g:form frm='GenSignatureFrm'>
		<g:hiddenField name="id" value=""/>

		<!--  show message -->
		<g:if test="${flash.message}"><div class="message">${flash.message}</div><br></g:if>

		<p style="text-align: right;"><span class="button"><g:actionSubmit class="edit" action="createWizard"
		                                                                   value="New Signature"/></span></p>

		<h1>Gene Signature List &nbsp;&nbsp;<a
				HREF="JavaScript:D2H_ShowHelp('1259','${grailsApplication.config.com.recomdata.adminHelpURL}','wndExternal',CTXT_DISPLAY_FULLHELP )">
			<img src="${resource(dir: 'images', file: 'help/helpicon_white.jpg')}" alt="Help" border=0 width=18pt
			     style="vertical-align:middle;margin-left:5pt;"/>
		</a></h1>

		<!-- show my signatures -->
		<table id="mySignatures" class="detail" style="width: 100%">
			<g:tableHeaderToggle label="My Signatures (${myItems.size()})" divPrefix="my_signatures" status="open"
			                     colSpan="${12}"/>
		...
		<!--
				  ...
				  <p style="text-align: right;"><span class="button"><g:actionSubmit class="edit" action="createListWizard"
		                                                                     value="New Gene/RSID List"/></span></p>

-->
        <!-- show my lists -->
		<table id="myLists" class="detail" style="width: 100%">
			<g:tableHeaderToggle label="My Lists (${myListItems.size()})" divPrefix="my_lists" status="open"
			                     colSpan="${5}"/>
		...
		<table id="publicLists" class="detail" style="width: 100%">
			<g:tableHeaderToggle label="Public Lists (${pubListItems.size()})" divPrefix="pub_lists" status="open"
			                     colSpan="${5}"/>
