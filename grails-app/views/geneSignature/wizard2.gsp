...
<!-- instructions -->
	...
	<g:form name='geneSignatureFrm'>
		...
		<table class="detail">
			...
			<tr class="prop">
				...
				<td class="value">
					<table>
						<tr>
							<td style="border: none; width; 33%;">i.e. LPS, polyIC, etc:</td><td
								style="border: none;"><g:textArea name="stimulusDescription" value="${gs.stimulusDescription}"
								                                  rows="3" cols="85"/></td>
						</tr>
						<tr>
							<td style="border: none; width; 33%;">Dose, units, and time:</td><td
								style="border: none;"><g:textField name="stimulusDosing" value="${gs.stimulusDosing}" size="67%"
								                                   maxlength="255"/></td>
						</tr>
					</table>
				</td>
			...
			<tr class="prop">
				...
				<td class="value">
					<table>
						<tr>
							<td style="border: none; width; 33%;">Drug treatment used in assay:</td><td
								style="border: none;"><g:textArea name="treatmentDescription" value="${gs.treatmentDescription}"
								                                  rows="6" cols="85"/></td>
						</td>
						</tr>
						<tr>
							<td style="border: none; width; 33%;">Dose, units, and time:</td><td
								style="border: none;"><g:textField name="treatmentDosing" value="${gs.treatmentDosing}"
								                                   size="67%" maxlength="255"/></td>
						</tr>
						...
						<tr>
							<td style="border: none; width; 33%;">Protocol Number:</td><td style="border: none;"><g:textField
								name="treatmentProtocolNumber" value="${gs.treatmentProtocolNumber}" size="67%"
								maxlength="255"/></td>
						</tr>
					</table>
				</td>
				...
				<td class="value">
					...
					<!--  toggle mouse other accordingly -->
						...
						<td style="border: none;">
							...
							<br><g:textField name="speciesMouseDetail" value="${gs.speciesMouseDetail}" size="100%"
							                 maxlength="255"/>
						</td>
					</tr>
					</table>
			...
			<tr class="prop">
				...
				<td class="value">
					<g:select name="tissueTypeConceptCode.id" from="${wizard.tissueTypes}"
					          value="${existingValues.'tissueTypeConceptCode.id'}"
					          noSelection="['null': 'select relevant tissue']"
					          optionValue='codeName' optionKey='id'/>
				</td>
			</tr>
			<tr class="prop">
				...
				<td class="value">
					<table>
						<tr>
							<td style="border: none; width: 50%">
								<g:select name="experimentTypeConceptCode.id" from="${wizard.expTypes}"
								          value="${existingValues.'experimentTypeConceptCode.id'}"
								          noSelection="['null': 'select experiment type']"
								          optionValue='codeName' optionKey='id'
								          onChange="toggleExpType(this);"/>
							...
							<!-- cell line lookup support -->
								<g:hiddenField name="experimentTypeCellLine.id"
								               value="${gs.experimentTypeCellLine ? gs.experimentTypeCellLine.id : 'null'}"/>
								<g:if test="${gs.experimentTypeCellLine}">
									<g:textField name="experimentTypeCellLineText" readonly="readonly" size="80%"
									             value="${existingValues.'experimentTypeCellLine.cellLineName' + ' (' + existingValues.'experimentTypeCellLine.attcNumber' + ')'}" /></g:if>
					...
					<!--  toggle in vivo model accordingly -->
						...
						<td style="border: none;">
							<label>For 'in vivo', describe model<g:requiredIndicator/>:</label><br><g:textField
								name="experimentTypeInVivoDescr" value="${gs.experimentTypeInVivoDescr}" size="100%"
								maxlength="255"/>
						</td>
					</tr>
						<tr><td style="border: none;"><label>If applicable, ATCC designation:</label><br><g:textField
								name="experimentTypeATCCRef" value="${gs.experimentTypeATCCRef}" size="100%" maxlength="255"/>
						</td></tr>
					</table>
				</td>
			</tr>
		...
		<div class="buttons">
			<g:actionSubmit action="${(wizard.wizardType == 1 || wizard.wizardType == 2) ? 'edit1' : 'create1'}"
			                class="previous" value="Definition"/>
			<g:actionSubmit action="${(wizard.wizardType == 1 || wizard.wizardType == 2) ? 'edit3' : 'create3'}"
			                class="next" value="Next" onclick="return validate();"/>
			<g:actionSubmit class="cancel" action="refreshSummary"
			                onclick="return confirm('Are you sure you want to exit?')" value="Cancel"/>
		</div>
