	...
	<tr><td>
		<table class="detail" width="100%" border=1>
			<tr>
				...
				<td style="font-weight: bold; white-space: nowrap;">Fold-Change Metric</td>
				</g:if>
			</tr>
			...
			<tr>
				...
				<g:if test="${gs.foldChgMetricConceptCode?.bioConceptCode != 'NOT_USED'}">
				<g:if test="${gs.foldChgMetricConceptCode?.bioConceptCode == 'TRINARY'}">
				<td class="name" style="text-align: right;">
					<g:formatNumber number="${it.foldChgMetric}" format="0"/>
				</td>
				</g:if>
				<g:else>
				<td class="name" style="text-align: right;">
