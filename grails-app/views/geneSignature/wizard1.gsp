...
<!-- instructions -->
	...
	<g:form name='geneSignatureFrm'>
		...
		<table class="detail">
			...
			<g:if test="${wizard.wizardType == 1}">
				<tr class="prop">
					...
					<td class="value">
						<g:radioGroup name="publicFlag" values="[true, false]" labels="['Yes', 'No']"
						              value="${gs.publicFlag}">
			...
			<tr>
				...
				<td style="font-weight: bold; font-style: italic;" colspan=2>
					Note, the creator of this signature was '${gs.createdByAuthUser?.userRealName}' on ${gs.dateCreated}
				</td>
				</g:if>
				<g:else>
				<td style="font-weight: bold; font-style: italic;" colspan=2>
		...
		<div class="buttons">
			<g:actionSubmit action="${(wizard.wizardType == 1 || wizard.wizardType == 2) ? 'edit2' : 'create2'}"
			                class="next" value="Meta-Data" onclick="return validate();"/>
