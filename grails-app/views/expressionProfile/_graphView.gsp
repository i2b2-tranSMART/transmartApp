...
<g:if test="${epr.graphURL && epr.graphURL != 'empty'}">
	<table>
		...
		<tr><td style="text-align: center;"><center>
			...
			<a href="#"
			   onclick="window.open('${printURL}', '_boxplot', 'width=850,height=600,resizable=yes,scrollbars=yes,location=no,menubar=yes');">
			...
			<g:each in="${epr.datasetItems}" status="i" var="ds">
				<tr class="${(i % 2) == 0 ? 'odd' : 'even'}">
					...
					<td style="vertical-align: top;">
						<a onclick="showDialog('ExpDetail_${ds.experimentId}', {
