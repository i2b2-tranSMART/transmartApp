<g:form>
	...
	<div id="divModifierEnum" style="text-align:left; padding: 20px;display:none;">
		<input id='chkEnableModifierValues' type='checkbox'
		       onclick='toggleValueConstraint();'/> Click here to constrain by value <br/><br/>
	...
	<div id="divModifierFloat" style="text-align:left; padding: 20px;display:none;">
		...
		<input type="radio" id="valueMethod_novalue" name="valueMethod" value="novalue"
		       onclick="valueMethodChanged(this.value)">&nbsp;No Value <br/>

		<input type="radio" id="valueMethod_numeric" name="valueMethod" checked="checked" value="numeric"
		       onclick="valueMethodChanged(this.value)">&nbsp;By Value<br/><br/>
		...
		<div id="divNumericMethod">
			...
			<div id="divHighValueModifier" style="display:none">AND<input type="text" size="5" name="highValueModifier"
			                                                              id="highValueModifier" value=""/></div>
