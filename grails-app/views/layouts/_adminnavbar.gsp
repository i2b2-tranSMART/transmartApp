...
<div class='navbarBox'>
	<div class="navcontainer1">
		...
		<ul class="navlist">
			<li>
				<span class="adminMenuButton">
					<g:link class='create' controller='secureObjectAccess'
					        action='manageAccess'>Access Control by Group</g:link>
				</span>
			</li>
			<li>
				<span class="adminMenuButton">
					<g:link class='create' controller='secureObjectAccess'
					        action='manageAccessBySecObj'>Access Control by Study</g:link>
				</span>
			</li>
		</ul>
	</div>
