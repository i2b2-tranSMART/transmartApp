			...
			<tr class="prop">
				<td width="300px" class="name" align=left
					...
					<a style="text-decoration: underline"
					   onclick="showDialog('AnalysisDet_${content.id}', {
						   title: '${content.shortDescription}',
						   element: 'detaildiv_${content.id}'
