...
<table class="searchform">
	...
	<tr>
		...
		<td>&nbsp;&nbsp;&nbsp;&nbsp;</td>
		<td><g:select name="snpViewChroms" from="${chroms}" value="${chromDefault}" multiple="multiple" size="5"/>
		</td>
	</tr>
	<tr>
		...
		<td>
			...
			<div id="divPathwaySNPViewer" style="width: 100%; font: 11px tahoma, arial, helvetica, sans-serif"><br>
				Add a Gene:<br>
