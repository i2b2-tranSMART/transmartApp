<div id="highdimension-filter-content">
	...
	<g:else>
		<table style="-webkit-border-horizontal-spacing: 10px; vertical-align: middle; width: 100%;">
			...
			<tr>
				<td>
					<label for="highdimension-filter-selector">Search term</label>
				</td
				><td>
				<input type="text" id="highdimension-filter-selector" style="width: 100%"/>
			</td>
			</tr>
			<tr>
				<td>Query on</td>
				<td>
					<select id="highdimension-filter-projection" style="width: 100%" onchange="omicsProjectionChanged()">
						<g:each in="${projections.keySet().sort { a, b -> projections.get(a) <=> projections.get(b) }}"
						        var="projection">
		...
		<g:if test="${filter_type == org.transmartproject.core.querytool.HighDimensionFilterType.SINGLE_NUMERIC || filter_type == org.transmartproject.core.querytool.HighDimensionFilterType.ACGH}">
			<table>
				<tbody>
				<tr id="highdimension-slider-row1"><td colspan="3">Number of subjects selected: <span
						id="highdimension-filter-subjectcount">0</span></td></tr>
				...
				<tr id="highdimension-slider-row3" style="display: none;">
					<td><input type="text" size="2" id="highdimension-amount-min" style="color:#548cff; font-weight:bold;">
					</td>
					<td><div id="highdimension-range"></div></td>
					<td><input type="text" size="2" id="highdimension-amount-max" style="color:#548cff; font-weight:bold;">
					</td>
				</tr>
				...
				<tr id="highdimension-slider-row6"><td>Bins:</td><td><div id="highdimension-bins"></div></td><td><input
						type="text" size="2" id="highdimension-amount-bins" readonly
						style="color:#548cff; font-weight:bold;"/></td></tr>
				</tbody>
			</table>
		</g:if>
