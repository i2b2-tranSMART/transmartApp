...
<td>
	<g:select class='addremoveselect' name='groupstoremove' optionKey='id' optionValue='principalAccessName'
              from="${soas}" size='15' multiple='yes'/>
</td>
...
<td>
	<div id="addfrombox">
		<g:select class='addremoveselect' width='100px' size='15' name='groupstoadd'
		          ...
		          optionValue='principalNameWithType'/>
</td>
</div>
</td>
