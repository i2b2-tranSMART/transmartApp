		...
		<div class="dialog">
			<table>
				...
				<tr class="prop">
					...
					<td valign="top"
					    class="value ${hasErrors(bean: ausa, field: 'accessLevel', 'errors')}">
						<g:select id="accessLevelList" optionKey='id' optionValue='accessLevelName'
						          from="${secureAccessLevels}" name='accessLevel.id' value="${ausa?.accessLevelId}"/>
					</td>
				</tr>
				...
				<tr class="prop">
					...
					<td valign="top"
					    class="value ${hasErrors(bean: ausa, field: 'secureObject', 'errors')}">
