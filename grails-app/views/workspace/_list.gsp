	...
	<g:each var="subset" in="${subsets}">
		<tr id="subsetRow${subset.id}" style="height:30px;">
			...
			<td style="padding:5px 20px 5px 30px;">
				<a id="displaySubset${subset.id}" class="ui-icon ui-icon-document" href="#"
				   ...
				   OnBlur="handleMouseOut('displaySubset${subset.id}'); hideQuery();"></a>
			</td>

			<td style="padding:5px 20px 5px 30px;">
				<g:if test="${subset.id == selectedSubsetId}">
				<input type="radio" id="applySubset${subset.id}" name="applySubset" value="${subset.id}"
				       onclick="applySubsets('${subset.id}')" checked="true" title="Apply Subset">
				</g:if>
				<g:else>
				<input type="radio" id="applySubset${subset.id}" name="applySubset" value="${subset.id}"
			...
			<td style="padding:5px 20px 5px 30px;">
				<a id="emailSubset${subset.id}" class="ui-icon ui-icon-mail-closed" href="javascript:void(0)"
			...
			<td style="padding:5px 20px 5px 30px;">
				<a id="linkifySubset${subset.id}" class="ui-icon ui-icon-link" href="javascript:void(0)"
...
<table class="detail" id="reports" style="width:100%;">
	...
	<g:each var="report" in="${reports}">
		<tr id="reportRow${report.id}" style="height:30px;">
			...
			<td>${report.study}</td>
			<td style="padding:5px 20px 5px 30px;">
				<a id="displayReportCodes${report.id}" class="ui-icon ui-icon-document" href="#"
				   ...
				   OnBlur="handleMouseOut('displayReportCodes${report.id}'); hideReportCodes();"></a>
			</td>

			<td style="padding:5px 20px 5px 30px;">
				<a id="runReport${report.id}" class="ui-icon ui-icon-play" href="#"
