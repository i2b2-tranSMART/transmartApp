...
<g:if test="${searchresult?.literatureCount() > 0}">
    <table style="padding:10px 5px 0px 5px;">
        <tr>
            <td>
                <table>
                    <tr><td style="line-height: 13px;"><b>Jubilant Oncology (${searchresult?.litJubOncCount()})</b>
                    </td></tr>
                    <tr><td style="padding:2px 0px 0px 20px;">Alterations (${searchresult?.litJubOncAltCount})</td>
                    </tr>
                    <tr><td style="padding:2px 0px 0px 20px;">Inhibitors (${searchresult?.litJubOncInhCount})</td>
                    </tr>
                    <tr><td style="padding:2px 0px 0px 20px;">Interactions (${searchresult?.litJubOncIntCount})</td>
                    </tr>
                </table>
            </td>
            <td>
                <table>
                    <tr><td><b>Jubilant Asthma (${searchresult?.litJubAsthmaCount()})</b>
                    </td></tr>
                    <tr><td style="padding:2px 0px 0px 20px;">Alterations (${searchresult?.litJubAsthmaAltCount})</td>
                    </tr>
                    <tr><td style="padding:2px 0px 0px 20px;">Interactions (${searchresult?.litJubAsthmaIntCount})</td>
                    </tr>
                    <tr><td style="padding:2px 0px 0px 20px;">Protein Effects (${searchresult?.litJubAsthmaPECount})</td>
                    </tr>
                </table>
            </td>
            <td width="50%">&nbsp;</td>
    ...
    <div class="paginateButtons" style="width: 100%;">
        ...
        &nbsp;&nbsp;
        <g:remotePaginate update="jubresult"
                          total="${searchresult.resultCount}"
                          controller="literature"
                          action="datasourceJubilant"
                                ...
                                <td align="left">
                                    <div style="float:none;">
                                        <a onclick="toggleDetail('${jubrifdivid}')">
                                            <div id="${jubrifdivid}_fclose"
                                                 style="visibility:hidden; display:none;width:16px;">
                                                <img src="${resource(dir: 'images', file: 'folder-minus.gif')}"
                                                     style="vertical-align:middle;"/>
                                            </div>

                                            <div id="${jubrifdivid}_fopen"
