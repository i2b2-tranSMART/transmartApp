...
<body>
	...
	<div class="container well">
		<h1>Request Controlled Data Access (Level 2)</h1>
		...
		<g:uploadForm controller='user' action='access'>
			...
			<div class="form-group">
				<label for="research_aims">Specific aims of research initiative<sup>*</sup>:</label>
			...
			<div class="form-group">
				<label for="research_summary">Brief summary of research protocol<sup>*</sup>:</label>
			...
			<div class="form-group">
				<label>Please upload IRB approval letter for your project (.pdf or .docx formats only). </label>
				<br />
	...
	<div class="container well">
		...
		If your request is missing information, the administrator will contact you to resolve any issues. Once your request is complete, it will be forwarded to the GRDR Data Access Committee. <br /> <br />
		This process could take up to six weeks.</p>
		<p>If you would like to check on the status of your request any time, you can contact Cassandra Perry at <a href="mailto:Cassandra_Perry@hms.harvard.edu">Cassandra_Perry@hms.harvard.edu</a>.<br /> <br />
			Once the Data Access Committee has approved your request, the administrator will change your access level in the system and an automated e-mail will be generative, informing you that you have new privileges. Your access will be granted for a period of 12 months. Once expired, you may re-apply if access to the data is still needed.</p>
	</div>
	</g:else>
