<g:set var='usertypeOptions' value="${['Academia', 'Government', 'HealthCare Provider', 'Industry (Biotech, Pharma)', 'Non-Profit Research Organization', 'Patient', 'Parent of Patient', 'Patient Advocate', 'Patient Advocacy Organization', 'Vendor (Software Developer)', 'Other']}" />
...
<div class="form-section">
	...
	<div class="col-xs-12">
		...
		<g:textArea name='about' required='required' class='form-control' rows='5' maxLength='600' value="${user.about}"
