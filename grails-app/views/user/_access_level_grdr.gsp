...
<div class="row">
	<div class="col-lg-12">
		...
		<p>This means that you are able to run <i>summary statistics</i> and <i>advanced statistics</i> queries, but you cannot see or download <b><i>patient-level data</i></b>.</p>
		...
		<p>After completing the above steps, a confirmation e-mail will be sent to you and the administrator will be notified of your request. The administrator will review the form and will coordinate its submission to the GRDR Data Access Committee.</p>
		<br/>
