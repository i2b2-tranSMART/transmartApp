	...
	<table class="jubfilter" style="width:600px">
		<tr>
			<th colspan=2 style="align: right">
				<span class="button">
					<g:submitButton class="search" onclick="submitChecked('trialfilter');" value="Filter Results"
					                action="filterTrial" name="trialfilterbutton"/>&nbsp;
				</span>
			</th>
		</tr>
		<tr>
		...
		<tr>
			<td colspan=2 style="border-right:0 solid #ccc">
				<table class="jubfiltersection">
					<tr>
					...
					<tr>
						...
						<td style="font-weight:normal">
							<g:textField name="foldChange"
							             value="${trialFilter?.foldChange}"/> (Minimum Fold Change Ratio +/-1.0)
						</td>
					</tr>
					<tr>
